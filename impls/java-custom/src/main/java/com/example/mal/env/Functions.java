...
public class Functions {
    ...
    public static final MalType PLUS = MalFn.of("+",
                                                args -> {
                                                    // (+) => 0
                                                    if (args.isEmpty()) {
    ...
    public static final MalType MINUS = MalFn.of("-",
                                                 args -> {
    ...
    public static final MalType MULTIPLY = MalFn.of("*",
                                                    args -> {
                                                        // (*) => 1
                                                        if (args.isEmpty()) {
    ...
    public static final MalType DIVIDE = MalFn.of("/",
                                                  args -> {
                                                      if (args.length() < 2) {
                                                          return MalError.of("Wrong number of arguments (0)");
                                                      }
